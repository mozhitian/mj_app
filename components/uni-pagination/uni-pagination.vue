<template>
	<view class="uni-pagination">
		...
		<view style="display: flex;position: absolute;left: 50%;">
			<input class="uni-pagination__num-current" v-model="currentIndex" @focus="checkVal" @blur="checkVal" style="width: 15px;font-size: 14px;text-align: right;margin-top: -1px;">/{{maxPage}}
		</view>
		<!-- <view class="uni-pagination__num">
			<input class="uni-pagination__num-current" v-model="currentIndex">
			<text v-model="maxPage"></text>
		</view> -->
	</view>
</template>
