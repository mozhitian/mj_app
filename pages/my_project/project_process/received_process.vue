<template>
	<view>
			...
			<view class="total">
				<view class="navigation_position">
					<view class="navigation">
						<view class="text" :class="{ active: checked.first }" @click="replace(1)">收样({{num[0]}})</view>
						<view class="text" :class="{ active: checked.second }" @click="replace(2)">试验({{num[1]}})</view>
						<view class="text" :class="{ active: checked.thrid }" @click="replace(3)">延期({{num[2]}})</view>
					</view>
				</view>
		...
		<view :class="{ cover: reveal.second }" @click="add"></view>
